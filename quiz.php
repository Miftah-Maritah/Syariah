...
<!-- site metas -->
<title>Quiz-Belajar Tajwid</title>
...
<body>
                        ...
                        <div class="limit-box">
                           <nav class="main-menu">
                              <ul class="menu-area-main">
                                 <li><a href="add_review.php">Review</a></li>
                                 <li><a href="#quiz">About</a></li>
    ...
    <div id="about" class="choose_section">
    	<div class="container">
    		<div class="col-sm-12">
    			<h1 class="choose_text">Latihan Pemahaman Ilmu Tajwid <span class="color">Tajwid</span></h1>
	...
	<div class="choose_section_" id="quiz">
        <div class="container">
            <iframe src="https://forms.gle/Z9whkd1evBhWT8jk6" title="Quiz" width="90%" height="900" style="border:1px solid black"></iframe>
        </div>
    </div>
...
-->
    ...
    <div class="copyright_main">
    	<div class="container">
    		<p class="copy_text">© 2021 All Rights Reserved. <a href="https://html.design">Free Website Templates</a></p>
    	</div>
    </div>
